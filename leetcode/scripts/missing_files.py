...
if __name__ == "__main__":
	...
	print(len(attempted_problems_ids))
	written_problems = glob.glob("C:\\Users\\soakula\\D\\Projects\\coding-prepation\\leetcode\\Problems\\*.py")
	written_problems.pop()
	written_problems_ids = []
	for problem in written_problems:
		filename = problem.replace('C:\\Users\\soakula\\D\\Projects\\coding-prepation\\leetcode\\Problems\\', '')
		if filename != "rename.py" and filename != "UpdateLists.py":
